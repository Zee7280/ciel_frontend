            ...
            <div className="max-w-5xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
                    ...
                    <div className="group relative p-10 rounded-[2rem] bg-slate-50 border-2 border-slate-100 overflow-hidden hover:shadow-lg transition-all duration-500">
                        {/* Faded X mark */}
                        <div className="absolute top-6 right-6 w-10 h-10 rounded-full bg-red-100 flex items-center justify-center">
                            <EyeOff className="w-5 h-5 text-red-400" />
                        </div>

                        <div className="mb-8">
                            <span className="text-xs font-black uppercase tracking-widest text-red-400 bg-red-50 px-3 py-1.5 rounded-full border border-red-100">Without CIEL</span>
                        </div>

                        <h3 className="text-2xl font-black text-slate-700 leading-snug mb-6 tracking-tight">
                            Community work is{" "}
                            <span className="text-red-400 line-through decoration-red-300">invisible</span>
                        </h3>
                    ...
                    {/* With CIEL */}
                    <div className="group relative p-10 rounded-[2rem] bg-gradient-to-br from-emerald-50 to-sky-50 border-2 border-emerald-100 overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-500">
                        {/* Glow */}
                        ...
                        <div className="mb-8">
                            <span className="text-xs font-black uppercase tracking-widest text-emerald-600 bg-emerald-100 px-3 py-1.5 rounded-full border border-emerald-200">With CIEL</span>
                        </div>

                        <h3 className="text-2xl font-black text-slate-900 leading-snug mb-6 tracking-tight">
                            Impact becomes{" "}
                            <span className="bg-gradient-to-r from-emerald-600 to-sky-600 bg-clip-text text-transparent">measurable & credible</span>
                        </h3>
                ...
                <div className="text-center p-12 rounded-[3rem] bg-slate-50 border-2 border-slate-100 relative overflow-hidden shadow-premium">
                    ...
                    <blockquote className="text-2xl md:text-3xl font-black text-slate-900 leading-tight relative z-10 max-w-3xl mx-auto tracking-tight">
