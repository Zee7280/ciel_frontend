                ...
                <div className="flex flex-wrap items-start justify-between gap-4">
                    <div>
                        ...
                        <p className="mt-1.5 max-w-3xl text-sm text-slate-500">
                            Submitted FYP / thesis records from students who named you as their supervisor.
                        </p>
                    </div>
                    <button
                        type="button"
                    ...
                    >
                        🧮 {showMeritModel ? "Hide merit model" : "Merit model — rank my supervisees"}
                    </button>
                </div>

                {showMeritModel && !loading && entries.length > 0 && (
                    <FypMeritPanel entries={entries} meritEndpoint="/api/v1/paths/fyp-thesis/merit-model" />
                )}
                ...
                {loading ? (
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white px-6 py-14 text-center">
                        ...
                        <p className="mt-1.5 text-sm text-slate-500">
                            {entries.length === 0
                                ? "Students who list your email as their supervisor will appear here once they submit."
