    ...
    return (
        <div className="space-y-12 pb-16">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="report-h2">Section 6 — Resources & Implementation Support</h2>
                    <p className="report-label">How Your Project Was Enabled</p>
                </div>
            </div>
            ...
            <div className="space-y-3">
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-report-primary text-white flex items-center justify-center font-black text-[10px]">6.0</div>
                    <h3 className="report-h3">Project Snapshot</h3>
                    <span className="report-label !text-[9px] !bg-slate-100 !px-3 !py-1 !rounded-full">Auto-Generated · Read-Only</span>
                </div>
                <div className="p-6 bg-slate-900 rounded-[2rem] text-white relative overflow-hidden group">
                    <div className="absolute right-0 top-0 w-32 h-32 bg-report-primary/20 rounded-full -mr-16 -mt-16 blur-3xl" />
                    <div className="relative z-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                        {[
                            ...
                            <div key={label} className="space-y-1">
                                <p className="report-label !text-[9px]">{label}</p>
                ...
                <div className="p-3 bg-amber-50 border border-amber-100 rounded-xl flex items-start gap-2">
                    ...
                    <p className="report-help !text-amber-800">This information is automatically pulled from previous sections and cannot be edited.</p>
                </div>
            </div>
            ...
            <div className="space-y-4">
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-report-primary text-white flex items-center justify-center font-black text-[10px]">6.1</div>
                    <h3 className="report-h3">Step 1 — Resource Confirmation</h3>
                </div>

                <div className="bg-white rounded-[2.5rem] border-2 border-slate-100 p-8 shadow-sm space-y-4">
                    <Label className="report-h3 !text-sm !tracking-tight">Did This Project Use Additional Resources?</Label>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        >
                            <p className="report-h3 !text-xs">⭕ Time & Volunteer Effort Only</p>
                            <p className={clsx("report-help", use_resources === 'no' ? "text-slate-300" : "text-slate-400")}>
                        ...
                        >
                            <p className="report-h3 !text-xs">⭕ Yes — Financial, Material, or Other Resources Were Used</p>
                            <p className={clsx("report-help", use_resources === 'yes' ? "text-report-primary-soft" : "text-slate-400")}>
                    ...
                    {use_resources === 'no' && (
                        <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 space-y-2 animate-in fade-in duration-300">
                            <p className="report-label !text-slate-600">System Records:</p>
            ...
            {use_resources === 'yes' && (
                <div className="space-y-6 animate-in fade-in slide-in-from-top-4 duration-500">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-report-primary text-white flex items-center justify-center font-black text-[10px]">6.2</div>
                            <h3 className="report-h3">Step 2 — Resource Contribution Details</h3>
                        </div>
                        <Button
                    ...
                    {resources.length === 0 ? (
                        <div className="py-16 text-center bg-slate-50 rounded-[2.5rem] border-2 border-dashed border-slate-200 space-y-3">
                            ...
                            <p className="report-label !text-sm">No resources added yet</p>
                            <Button type="button" onClick={addResource} variant="ghost" className="h-9 px-5 bg-slate-900 text-white report-label !text-white rounded-xl">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-report-primary text-white flex items-center justify-center font-black text-[10px]">6.3</div>
                            <h3 className="report-h3">Step 3 — Optional Evidence Upload</h3>
                        </div>
                        <div className="bg-white rounded-[2.5rem] border-2 border-slate-100 p-8 shadow-sm space-y-6">
                            <div className="flex items-start gap-3 p-4 bg-report-primary-soft rounded-xl border border-report-primary-border">
                            ...
                            <div className="space-y-3">
                                <Label className="report-label">Accepted Document Types</Label>
                                <div className="flex flex-wrap gap-2">
                                    {evidenceDocTypes.map(doc => (
                                        <span key={doc} className="px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg report-label !text-[9px]">
                                            <FileText className="w-3 h-3" /> {doc}
                                        </span>
                                    ))}
                                </div>
                            </div>
                            <div className="relative border-2 border-dashed border-slate-200 rounded-2xl p-8 text-center space-y-3 hover:border-report-primary-border transition-colors group">
                                <FileText className="w-8 h-8 text-slate-200 mx-auto group-hover:text-report-primary-border transition-colors" />
                                <p className="report-label group-hover:text-report-primary transition-colors">Drag & drop or click to upload</p>
                                <input
                    ...
                    <div className="pt-8 border-t-2 border-slate-100 space-y-6">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                <div className="w-10 h-10 rounded-xl bg-report-primary text-white flex items-center justify-center">
                                    <Activity className="w-5 h-5" />
                                </div>
                                <h3 className="report-h3 !text-lg">System-Generated Resource Summary</h3>
                            </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {[
                                ...
                                <div key={label} className={clsx("rounded-2xl p-4 space-y-1", color)}>
                                    ...
                                    <p className="report-label !opacity-70">{label}</p>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="bg-white border-2 border-slate-200 rounded-[2.5rem] p-8 relative overflow-hidden">
                            ...
                            <p className="report-ai-text !text-lg !not-italic">
                                {autoNarrative}
                            </p>
                        </div>
                    </div>
