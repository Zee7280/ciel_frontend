...
const FALLBACK: PlatformStatsPayload = {
    ...
    data: {
        ...
        people_reached: 6000,
        people_serving: 40,
        report_verified_hours: 1800,
        resources_deployed_pkr: 750000,
        out_of_pocket_pkr: 200000,
        community_dividend_pkr: 1100000,
        dividend_hourly_rate_pkr: 500,
        partner_organisations: 30,
        verified_projects_all_paths: 60,
        cities_live: 0,
        sdgs_touched_by_reports: 8,
...
export async function GET() {
    ...
    const normalized: PlatformStatsPayload = {
        ...
        data: {
            ...
            dividend_hourly_rate_pkr: normalizeCount(d.dividend_hourly_rate_pkr, FALLBACK.data.dividend_hourly_rate_pkr ?? 500),
