...
/** Proxies Nest `GET /admin/paths/fyp-thesis` (forwards query string). */
export async function GET(request: Request) {
    try {
        ...
        const backendUrl = new URL(`${base}/admin/paths/fyp-thesis`);
        ...
        console.error("admin/paths/fyp-thesis GET proxy:", error);
