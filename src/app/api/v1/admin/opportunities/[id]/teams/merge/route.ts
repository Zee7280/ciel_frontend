...
/** Proxies Nest `POST /admin/opportunities/:opportunityId/teams/merge`. */
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        const response = await fetch(`${base}/admin/opportunities/${encodeURIComponent(id)}/teams/merge`, {
            method: "POST",
            headers: {
        ...
        console.error("admin/opportunities/[id]/teams/merge POST proxy:", error);
