...
export async function POST(request: Request) {
    ...
    try {
        ...
        if (applicantId && status) {
            ...
            externalApiUrl = `${process.env.NEXT_PUBLIC_APP_API_BASE_URL}/partners/opportunities/applicants/update`;
            ...
            externalApiUrl = `${process.env.NEXT_PUBLIC_APP_API_BASE_URL}/partners/opportunities/applicants`;
            requestBody = { id };
